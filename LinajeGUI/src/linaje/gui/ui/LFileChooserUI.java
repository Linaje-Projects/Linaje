 ...
 * @author Jeff Dinkins
 * 
 * Esto es una adaptación de WindowsFileChooserUI para LinajeLookAndFeel
 * 
 * @see WindowsPlacesBar
 */
public class LFileChooserUI extends BasicFileChooserUI {
    ...
    // Preferred and Minimum sizes for the customDialog box
    ...
    public static ComponentUI createUI(JComponent c) {
        return new LFileChooserUI((JFileChooser) c);
    }

    public LFileChooserUI(JFileChooser filechooser) {
        super(filechooser);
    }
    ...
    private class LFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
        public JFileChooser getFileChooser() {
            return LFileChooserUI.this.getFileChooser();
        }

        public BasicDirectoryModel getModel() {
            return LFileChooserUI.this.getModel();
        }

        public JPanel createList() {
            return LFileChooserUI.this.createList(getFileChooser());
        }

        public JPanel createDetailsView() {
            return LFileChooserUI.this.createDetailsView(getFileChooser());
        }

        public boolean isDirectorySelected() {
            return LFileChooserUI.this.isDirectorySelected();
        }

        public File getDirectory() {
            return LFileChooserUI.this.getDirectory();
        }

        public Action getChangeToParentDirectoryAction() {
            return LFileChooserUI.this.getChangeToParentDirectoryAction();
        }

        public Action getApproveSelectionAction() {
            return LFileChooserUI.this.getApproveSelectionAction();
        }

        public Action getNewFolderAction() {
            return LFileChooserUI.this.getNewFolderAction();
        }

        public MouseListener createDoubleClickListener(JList list) {
            return LFileChooserUI.this.createDoubleClickListener(getFileChooser(), list);
        }

        public ListSelectionListener createListSelectionListener() {
            return LFileChooserUI.this.createListSelectionListener(getFileChooser());
        }
    }

    public void installComponents(JFileChooser fc) {
        filePane = new FilePane(new LFileChooserUIAccessor());
        ...
        final JRadioButtonMenuItem listViewMenuItem = new JRadioButtonMenuItem(filePane.getViewTypeAction(FilePane.VIEWTYPE_LIST));
        ...
        final JRadioButtonMenuItem detailsViewMenuItem = new JRadioButtonMenuItem(filePane.getViewTypeAction(FilePane.VIEWTYPE_DETAILS));
        ...
        BufferedImage image = new BufferedImage(viewMenuIcon.getIconWidth() + 7, viewMenuIcon.getIconHeight(), BufferedImage.TYPE_INT_ARGB);
        ...
        // Details Button
        final JButton viewMenuButton = createToolButton(null, new ImageIcon(image), viewMenuButtonToolTipText, viewMenuButtonAccessibleName);
    ...
    private void updateUseShellFolder() {
        ...
        if (FilePane.usesShellFolder(fc)) {
            if (placesBar == null && !UIManager.getBoolean("FileChooser.noPlacesBar")) {
                placesBar = new WindowsPlacesBar(fc);
     ...
     * the selected file changing, or the type of the customDialog changing.
     */
    ...
    private static JButton createToolButton(Action a, Icon defaultIcon, String toolTipText, String accessibleName) {
        final LButton result = new LButton(a);

        result.setText(null);
        result.setIcon(defaultIcon);
        //result.getButtonProperties().setIconForegroundEnabled(false);
