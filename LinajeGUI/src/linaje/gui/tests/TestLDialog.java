...
public class TestLDialog {
	...
	public static void main(String[] args) {
		...
		//lDialog.setTransparency(0);
		lDialog.setBackgroundContent(Colors.darker(Color.blue, 0.5));
		lDialog.setTransparency(0.3f);
		lDialog.getDefaultRoundedBorder().setLineBorderColor(Color.magenta);
		//StateColor foreground = new StateColor(ColorsGUI.getColorTextBrightest(), null,ColorsGUI.getColorApp());
		//lDialog.setForeground(foreground);
		lDialog.setForeground(ColorsGUI.getColorTextBrightest());
		//lDialog.setResizable(true);
		...
		/*lDialog.setSize(lDialogContent.getSize());
		lDialog.setContentPane(lDialogContent);
		UtilsGUI.centrarVentana(lDialog);
